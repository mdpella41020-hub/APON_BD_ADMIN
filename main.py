...
# ================= CONFIG =================
BOT_TOKEN = os.getenv("BOT_TOKEN", "8629087257:AAGMyeLpMBfMov4VXVKCdTOm-3FOs0GCNqA")
...
@app.route('/')
def home():
    return "🚀 Apon Hosting Bot is running!", 200
...
def start(message):
    ...
    user_info_text = (
        ...
        f"👤 **Username:** {username}\n"
        f"📝 **Bio:** {bio}\n\n"
        f"Apon Hosting Bot is a Telegram bot that makes managing your hosting and servers easy. "
