...
# ================= CONFIG =================
BOT_TOKEN = os.getenv("BOT_TOKEN", "8381632107:AAHT5CauVp6o5lDLbazhyB2Rnv9xgQLdBZ8")
ADMIN_ID = int(os.getenv("ADMIN_ID", "8423357174"))
...
@app.route('/')
def home():
    return "🚀 BD ADMIN X Hosting Bot is running!", 200
...
══════════════════════════════════════════════════════════════
    🚀 BD ADMIN X Hosting Bot is RUNNING!
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def premium_menu(user_id):
    ...
    markup.row(types.InlineKeyboardButton("👤 Contact Owner @BD_ADMIN_20", url="https://t.me/BD_ADMIN_20"))
...
def start(message):
    ...
    user_info_text = (
        ...
        f"👤 **Username:** {username}\n"
        f"📝 **Bio:** {bio}\n\n"
        f"BD ADMIN X Hosting Bot is a Telegram bot that makes managing your hosting and servers easy. "
...
def got_payment(message):
    ...
    bot.send_message(message.chat.id, "🎉 **Payment Successful!**\n\n✅ Your Premium Plan has been activated! BY BD ADMIN 💎", parse_mode="Markdown")
...
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
  ...
  ✨ "Empowering your code with elite performance" """
        ...
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("Message Owner", url="https://t.me/BD_ADMIN_20"))
...
✨ Bot is running smoothly!"""
        ...
        if data_parts[0] == "ADM":
            ...
            if action == "FILE_MAN":
                ...
                save_data(BLOCK_FILE, blocked_users)
                try:
                    bot.send_message(t, "🚫 You have been blocked by an admin. Contact @BD_ADMIN_20 for help.")
                except:
                    pass
            ...
            if token not in clone_requests:
                ...
                try:
                    bot.send_message(user_id_req, f"😞 **Your clone request was rejected.**\n\n"
                                                 f"**Bot:** `@{safe_markdown(bot_name)}`\n\n"
                                                 f"Contact @BD_ADMIN_20 for questions.", parse_mode="Markdown")
                except:
                    pass
