...
def load_credentials_from_file(filename="Ariyan.txt"):
    """
    ...
    try:
        ...
        fields = {
            ...
            2: {
                ...
                6: "iG:[C][B][FF0000] @NoTmeowL",  # Nickname
                7: 330,                   # Rank
                8: 1000,                  # Field 8
...
async def evo_cycle_spam(uids, key, iv, region, LoGinDaTaUncRypTinG):
    ...
    while evo_cycle_running:
        ...
        for index, (emote_number, emote_id) in enumerate(emote_list):
            ...
            # BOT does ONLY opposite emote (One time)
            opposite_index = total_emotes - 1 - index
            opposite_number, opposite_id = emote_list[opposite_index]
            
            try:
                # বট এখন শুধু নিজেকে ইমোট পাঠাবে (Visibility fixed to 1)
...
[00FFFF]██║░░██║[FFFF00]██║░░██║[ff00ae]██║[FFA500]░░░██║░░░[00FF00]██║░░██║[0600ff]██║░╚███║
[00FFFF]╚═╝░░╚═╝[FFFF00]╚═╝░░╚═╝[ff00ae]╚═╝[FFA500]░░░╚═╝░░░[00FF00]╚═╝░░╚═╝[0600ff]╚═╝░░╚══╝
ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ [FFFF00]ᴀᴘᴏɴ [FFA500]ʙᴏᴛ [FFD700]THANKS [FFFF00]FOR YOU [00FF00]MESSAGE TO[FFFF00] /HELP AND [FFA500]COMMAND TO[FFFF00] ALL AND[FFFF00] INJOY YOU
...
[C][B][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF] ᴡʟᴄ ᴀᴘᴏɴ ʙᴏᴛ [FFFF00]║
...
"""
                                ...
                                credentials = load_credentials_from_file("Ariyan.txt")
                                if not credentials:
...
[C][B][00FF00] ❤️ BOT DEVELOPER: 
[C][B][FFFFFF]ZENON-APON ✿ ❤️

[B][C][FFFFFF]OWNER : ✿ ZENON-APON ✿
[B][C][FFFFFF]ADMIN : LIKE-BOT-FF

[C][B][00FF00]🆔 OWNER UIDs:
[FFFFFF]
1[C]4[C]1[C]4[C]5[C]9[C]8[C]4[C]37[C]0[C]3[C] & 2[C]6[C]8[C]4[C]0[C]6[C]3[C]8[C]7[C]3[C] ❤️
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            basic = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]ⓕ[C81F9C]֯│[FFFF00]║[FFFFFF] ʙᴀsɪᴄ ᴄᴏᴍᴍᴀɴᴅ[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[0000FF]/start       [DDA0DD]Start match
[6B8E23]/exit        [9932CC]Leave squad
[0000FF]/3           [DDA0DD]Send 3-player invite
[6B8E23]/5           [9932CC]Send 5-player invite
[0000FF]/6           [DDA0DD]Send 6-player invite
[6B8E23]! (team code)   [9932CC]Join squad
[0000FF]/ghost (team code)  [DDA0DD]Ghost join squad
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            emotes = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF]ᴇᴍᴏᴛᴇ ᴄᴏᴍᴍᴀɴᴅ[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[0000FF]/e [emote]        [DDA0DD]Send emote to yourself
[6B8E23]/e [uid] [emote]  [9932CC]Send emote to player
[0000FF]/e list           [DDA0DD]Show all emotes
[6B8E23]/e list names     [9932CC]Show named emotes
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            evo = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]◯[C81F9C]֯│[FFFF00]║[FFFFFF] ᴍx ᴄᴏᴍᴍᴀɴᴅ [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB][0000FF]@evos            [DDA0DD]Start evolution cycle
[6B8E23]/s           [9932CC]Stop evolution cycle
[0000FF]/evo [num]       [DDA0DD]Send evo emote (1-18)
[6B8E23]/evo [uid] [num] [9932CC]Send evo emote to player
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
"""
                            ...
                            spam_cmnd = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]ⓕ[C81F9C]֯│[FFFF00]║[FFFFFF] ᴠɪᴘ ᴄᴏᴍᴍᴀɴᴅ [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[0000FF]/fast [uid] [emote]    [DDA0DD]Fast emote spam
[6B8E23]/p [uid] [emote] [num] [9932CC]Custom emote spam
[0000FF]/reject [uid]          [DDA0DD]Reject spam
[6B8E23]/reject_stop           [9932CC]Stop reject spam
[0000FF]/msg [text] [times]    [DDA0DD]Message spam
[6B8E23]/stop msg              [9932CC]Stop message spam
[0000FF]/mg [text] [repeats]   [DDA0DD]Wave message spam
"""
                            ...
                            badge_cmnd = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF] ᴠ ʙᴀᴅɢᴇ sᴘᴀᴍ [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[0000FF]/s1 [uid]  [DDA0DD]Spam with badge 1
[6B8E23]/s2 [uid]  [9932CC]Spam with badge 2
[0000FF]/s3 [uid]  [DDA0DD]Spam with badge 3
[6B8E23]/s4 [uid]  [9932CC]Spam with badge 4
[0000FF]/s5 [uid]  [DDA0DD]Spam with badge 50
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            ad_cmnd = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]◯[C81F9C]֯│[FFFF00]║[FFFFFF] ᴀᴅᴠᴀɴᴄᴇ [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[0000FF]/inv [uid]           [DDA0DD]Send group invite
[6B8E23]/joinroom [id] [pass] [9932CC]Join custom room
[0000FF]/lag [team_code]     [DDA0DD]Lag attack squad
[6B8E23]/stop lag            [9932CC]Stop lag attack
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            info_cmnd = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]ⓕ[C81F9C]֯│[FFFF00]║[FFFFFF] ɪɴғᴏ ᴄᴏᴍᴍᴀɴᴅ [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━
[0000FF]/info [uid]       [DDA0DD]Player information
[6B8E23]/status [uid]     [9932CC]Check player status
[0000FF]/gali [name]      [DDA0DD]Gali spam message
[6B8E23]/likes [uid]      [9932CC]Send 100 likes
[0000FF]/ai [question]    [DDA0DD]Chat with AI
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            about = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF] ᴀᴅᴍɪɴ ɪɴғᴏ[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[DC143C]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[0000FF]/help        [DDA0DD]Show this help menu
[6B8E23]/admin       [9932CC]Admin/contact information
[0000FF]/quick [code] [emote] [uid] [DDA0DD]Quick emote attack
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            whitelist_cmnd = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]◯[C81F9C]֯│[FFFF00]║[FFFFFF] ᴡᴇʙ ʟɪsᴛ[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[0000FF]/wllist          [DDA0DD]View whitelisted UIDs
[6B8E23]/wladd (uid)     [9932CC]Add UID to whitelist
[0000FF]/wlremove (uid)  [DDA0DD]Remove UID from whitelist
[6B8E23]/wlenable        [9932CC]Enable whitelist-only mode
[0000FF]/wldisable       [DDA0DD]Disable whitelist-only mode
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            last = """
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗
[C][B][FF7244]│[FE4250]ⓕ[C81F9C]֯│[FFFF00]║[FFFFFF] ᴏᴡɴᴇʀ ɪɴғᴏ [FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝ [FFC0CB]╔═•══•════════════════•══•═╗
[B0E0E6]║ ⚡ [B][00FF00]ʙᴏᴛ ɪɴғᴏ[00FF00][/B] ⚡
[00CED1]║
[FFC0CB]║ 👤 ᴏᴡɴᴇʀ  ✿ ✿  :: [B0E0E6]❖ᴢᴇɴᴏɴ•ᴀᴘᴏɴ❖
[00CED1]║ 💻 sᴛᴀᴛᴜs       :: [AFEEEE]ᴏɴʟɪɴᴇ
[FFC0CB]║ 🛠 ᴀᴅᴍɪɴ  ✿   :: [B0E0E6]❖ᴢᴇɴᴏɴ•ᴀᴘᴏɴ❖
[00CED1]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from Ariyan.txt...")
    credentials = load_credentials_from_file("Ariyan.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create Ariyan.txt with your UID and password")
