...
@app.route('/')
def home():
    return "🚀 BD_ADMIN Hosting Bot is running!", 200
...
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
    🚀 BD_ADMIN Hosting Bot is RUNNING!
    ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def start(message):
    ...
    user_info_text = (
        ...
        f"👤 **Username:** {username}\n"
        f"📝 **Bio:** {bio}\n\n"
        f"BD_ADMIN Hosting Bot is a Telegram bot that makes managing your hosting and servers easy. "
            ...
            if token not in clone_requests:
                ...
                try:
                    bot.send_message(user_id_req, f"😞 **Your clone request was rejected.**\n\n"
                                                 f"**Bot:** `@{safe_markdown(bot_name)}`\n\n"
                                                 f"Contact @BD_ADMIN_20 questions.", parse_mode="Markdown")
                except:
                    pass
