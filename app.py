...
<head>
    ...
    <title>ʙᴅ➺ꫝᴅᴍɪɴ ULTRA TERMINAL v3.0</title>
...
<body class="py-6 px-4 max-w-xl mx-auto flex flex-col justify-start">
    ...
    <div class="space-y-6">
        ...
        <div class="cyber-panel">
            <div class="panel-title-bar">
                ...
                <h2 class="neon-text-magenta">ʙᴅ➺ꫝᴅᴍɪɴ UNLIMITED MODE</h2>
            </div>
        ...
        <div class="cyber-panel">
            <div class="panel-title-bar">
                ...
                <h2 class="neon-text-cyan">ʙᴅ➺ꫝᴅᴍɪɴ ACTIVE PIPELINE</h2>
            </div>
    ...
    <footer class="mt-10 mb-4 text-center text-[11px] font-semibold text-[#a0aec0] tracking-widest uppercase font-poppins">
        System Managed & Engineered By <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-500 font-bold">ʙᴅ➺ꫝᴅᴍɪɴ</span> &copy; 2026
    </footer>
                    ...
                    if (data.accounts && data.accounts.length) {
                        accListDiv.innerHTML = data.accounts.map(acc => `
                            <div class="text-xs bg-[#0d091f] border border-purple-900/40 px-4 py-3 rounded-full text-gray-300 flex items-center justify-between font-poppins">
                                <span class="flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-[#00ffcc] shadow-[0_0_6px_#00ffcc]"></span> ʙᴅ➺ꫝᴅᴍɪɴ_NODE</span>
            ...
            fetch(url)
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        showToastNotification('startMessage', `ʙᴅ➺ꫝᴅᴍɪɴ Core Deploy Success: Active`);
